...
function Session() {
	...
	this.urls = {
		...
		projects: 'https://vba.dse.vic.gov.au/vba/vba/sc/IDACall?isc_rpc=1&isc_v=SC_SNAPSHOT-2010-08-03&isc_xhr=1',
	};
	...
	this.login = function(credential, expressRes) {
		var me = this;
	...
	this.getProject = function() {
		...
		request({
				jar: this.jar,
				url: this.urls.projects, //URL to hit
				method: 'POST',
				headers: headers,
				form: {
